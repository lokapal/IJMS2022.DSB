...
# Output: 1. HEK293.4C.hg38.nodfam.intersect.txt        HEK293T 4C genome mappings intersections rep1 and rep2, DFAM removed table
#         2. HEK293.4C.hg38.nodfam.intersect.bedGraph   HEK293T 4C hg38 profile for genome browsers
#         3. 4C.HEK293.hg38.intersect.all.txt           HEK293T 4C intersect noDFAM with genes and expression added, all entries (with genes intersections and empty)
#         4. 4C.HEK293.hg38.intersect.genes.txt         HEK293T 4C intersect noDFAM with genes and expression added, genes intersections only
#
# Dependency tools:
...
./lib/mergebedgraphmean.sh intersect_reps.bedGraph HEK293.4C.hg38.nodfam.intersect.bedGraph
./lib/addSubseq.pl /usr/local/genomes/hg38.mfa intersect_merged.bed > HEK293.4C.hg38.nodfam.intersect.txt
sort -k1,1 -k2,2n -k3,3n HEK293.4C.hg38.nodfam.intersect.txt -o HEK293.4C.hg38.nodfam.intersect.txt
#
# Part 2. Assign genes to HEK293T 4C-associated intersected replicates noDFAM mappings
cp HEK293.4C.hg38.nodfam.intersect.txt 4C.bed
...
./lib/tbl_addexpr.pl 4C.genetable ./lib/HEK293.hg38.mean.TPM
cat 4C.genetable.expr 4C.empty > 4C.HEK293.hg38.intersect.all.txt
mv 4C.genetable.expr 4C.HEK293.hg38.intersect.genes.txt
sort -k1,1V -k2,2n -k3,3n 4C.HEK293.hg38.intersect.genes.txt -o 4C.HEK293.hg38.intersect.genes.txt
sort -k1,1V -k2,2n -k3,3n 4C.HEK293.hg38.intersect.all.txt -o 4C.HEK293.hg38.intersect.all.txt
