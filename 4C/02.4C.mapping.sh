...
# Input:  1. GSE121413  HEK293T 4C-rDNA reads after adapter removing
...
#
bwa mem -t 20 /usr/local/genomes/hg38.mfa final.rep1.fastq.gz | samtools view -bS -F 4 -o hits.bam
